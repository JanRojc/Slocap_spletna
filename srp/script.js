...
timelineBtn7.fromTo("#btn7", {backgroundPosition: "-155px 0px"}, {backgroundPosition: "0px 0px", duration:.5});
...
function showDropdown3() {
  document.getElementById("dropdownPlaceholder").innerHTML = '\
    ...
    <div id="dropdownId3"><button onmouseenter="underlineBtn6In()" onmouseleave="underlineBtn6Out()" class="button2" onclick="functionPolilaminat()"><a id="btn6">-> Polilaminat kapice za</br>boce od penušava vina</a></button></div> \
		<div id="dropdownId4"><button onmouseenter="underlineBtn7In()" onmouseleave="underlineBtn7Out()" class="button2" onclick="functionAluminij()"><a id="btn7">-> Aluminijske kapice za bureta</a></button></div> \
    <div id="dropdownId6"><button onmouseenter="underlineBtn8In()" onmouseleave="underlineBtn8Out()" class="button" onclick="functionKontakt()"><a id="btn8">Kontakt</a></button></div> \
    <div class="positionSlikaSide"><img src="../images/podjetje_side.jpg" width="176" height="264" border="0" class="rounded_top rounded_bot"/><br /></div></div>';
    reload();
}
