...
timelineBtn1.fromTo("#btn1", {backgroundPosition: "-70px 0px"}, {backgroundPosition: "0px 0px", duration:.3});
...
timelineBtn5.fromTo("#btn5", {backgroundPosition: "-75px 0px"}, {backgroundPosition: "0px 0px", duration:.3});

  timelineBtn6 = new TimelineMax({paused:true});
timelineBtn6.fromTo("#btn6", {backgroundPosition: "-245px 0px"}, {backgroundPosition: "0px 0px", duration:.6});

  timelineBtn7 = new TimelineMax({paused:true});
timelineBtn7.fromTo("#btn7", {backgroundPosition: "-157px 0px"}, {backgroundPosition: "0px 0px", duration:.5});
...
function showDropdown1() {
  document.getElementById("dropdownPlaceholder").innerHTML = '\
      ...
      <div id="dropdownId7"><button onmouseenter="underlineBtn1In()" onmouseleave="underlineBtn1Out()" class="button" onclick="functionDoma()"><a id="btn1">Naslovnica</a> </button></div> \
      <div id="dropdownId8"><button onmouseenter="underlineBtn2In()" onmouseleave="underlineBtn2Out()" class="button" onclick="functionPodjetje()"><img id="arrowhead1" src="../images/arrowhead.png" height="10" border="0"> <a id="btn2">O nama</a></button></div> \
...
function showDropdown3() {
  document.getElementById("dropdownPlaceholder").innerHTML = '\
    ...
    <div id="dropdownId8"><button onmouseenter="underlineBtn2In()" onmouseleave="underlineBtn2Out()" class="button" onclick="functionPodjetje()"><img id="arrowhead1" src="../images/arrowhead.png" height="10" border="0"> <a id="btn2">O nama</a></button></div> \
    <div id="dropdownId5"><button onmouseenter="underlineBtn4In()" onmouseleave="underlineBtn4Out()" class="button" onclick="functionProizvodi()"><img id="arrowhead2" src="../images/arrowhead.png" height="10" border="0"> <a id="btn4">Proizvodi</a></button></div> \
    <div id="dropdownId2"><button onmouseenter="underlineBtn5In()" onmouseleave="underlineBtn5Out()" class="button2" onclick="functionPVC()"><a id="btn5">-> PVC Kapice</a></button></div> \
    <div id="dropdownId3"><button onmouseenter="underlineBtn6In()" onmouseleave="underlineBtn6Out()" class="button2" onclick="functionPolilaminat()"><a id="btn6">-> Polilaminatne kapice za</br>boce od pjenušava vina</a></button></div> \
		<div id="dropdownId4"><button onmouseenter="underlineBtn7In()" onmouseleave="underlineBtn7Out()" class="button2" onclick="functionAluminij()"><a id="btn7">-> Aluminijski poklopci za bačve</a></button></div> \
    <div id="dropdownId6"><button onmouseenter="underlineBtn8In()" onmouseleave="underlineBtn8Out()" class="button" onclick="functionKontakt()"><a id="btn8">Kontakt</a></button></div> \
    <div class="positionSlikaSide"><img src="../images/podjetje_side.jpg" width="176" height="264" border="0" class="rounded_top rounded_bot"/><br /></div></div>';
    reload();
}
